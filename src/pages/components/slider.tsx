        ...
        <div>
          ...
          <div className="flex items-center flex-col xl:flex-row">
            <input
              ...
              className="w-60 h-12 sm:w-72 xl:mt-3 mt-2 mb-3 bg-[#6b6b6b] appearance-none outline-none overflow-hidden rounded-full cursor-grab active:cursor-grabbing bg-gradient-to-r from-orange-800 via-orange-600 to-orange-400 animate-custom bg-[length:200%]"
            />
